...
def main():
    ...
    with open(args.save_local_dir+"Rewards_"+str(args.env_name)+"_seed_"+str(args.seed)+"_est_beta_"+str(args.est_beta_value)+"_beta_reg_"+str(args.reg_beta)+"_entropy_"+str(args.entropy_coef)+".pkl", 'wb') as f:
        pickle.dump(all_rewards_local, f)

    with open(args.save_local_dir+"Frames_"+str(args.env_name)+"_seed_"+str(args.seed)+"_est_beta_"+str(args.est_beta_value)+"_beta_reg_"+str(args.reg_beta)+"_entropy_"+str(args.entropy_coef)+".pkl", 'wb') as f:
